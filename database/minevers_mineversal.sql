...
--
-- Host: localhost:3306
-- Generation Time: Dec 08, 2020 at 11:41 AM
...
(32, 1, 'Mineversal Documentation', 'Pengingat', 'Upload Videonya ke Youtube!!'),
(35, 2, 'Minggu', 'Kerjain Tugas', 'Kuliah Full Time'),
(31, 26, 'Zidan', 'Zidan hari ini', 'Zidan besok');
...
(1, 'joe', 'azhar065001900001@std.trisakti.ac.id', '$2y$10$P/YZLUVo..Jzjv5h2MjQPehC0CBXgNQQaMzIMbA0O4YPuvVSA6Mk2', 'Azhar Rizky Zulma'),
...
(35, 'isnisar28', 'isn.rdnf@gmail.com', '$2y$10$pvCGcbakqiA012ZR5nJN6eyXLjxIF0Fq2cpcteAl5E60xh852S8xm', 'Isnisa R'),
...
--
ALTER TABLE `habit`
  MODIFY `id_habbit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
