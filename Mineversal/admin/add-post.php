...
if(isset($_POST['submit'])) {
    ...
    if(!in_array($extension, $allowed_extensions)) {
        ...
        $status = 1;
        $query = mysqli_query($kon,"INSERT into post(admin, title, description, url, Is_Active, image, provinsi) values ('$admin','$title','$description','$url','$status','$imgnewfile','$prov')");
        if($query){
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-sm">
                                    <tbody>
                                        <tr>
                                            <td><h3>Judul</h3></td>
                                            <td><input class="my-auto TextField" type="text" name="title" placeholder="Enter Title" required/></td>
                                        </tr>
                                        <tr>
                                            <td><h3>Deskripsi</h3></td>
                                            <td><textarea class="my-auto TextArea" type="text" name="description" placeholder="Enter Description" required/></textarea></td>
                                        </tr>
                                        <tr>
